...
export const untilDateRegex =
  /(until|to|end:?):?\s?\[\[(\b(?:January|February|March|April|May|June|July|August|September|October|November|December)\s(?:1st|2nd|3rd|[4-9]th|1\d{1}th|2\d{1}th|30th|31st),\s\d{4}\b)\]\]/i;
